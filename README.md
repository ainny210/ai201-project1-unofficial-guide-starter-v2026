...
I kept each document as one chunk because the campus_life corpus contains short, focused posts. In my indexing output, the 88 documents produced 88 chunks with an average length of 317 characters, with the shortest at 178 and the longest at 549 characters. Keeping each short post intact preserves the complete thought instead of splitting it at an arbitrary character limit.
